...
public:
	...
	/** 击杀提示 */
	void KillPrompt(const int64& KillerPlayerID, const int64& KilledPlayerID);
...
FORCEINLINE bool operator==(const UMobaKillSystemComponent::FAccumulatedKill& Lhs, const UMobaKillSystemComponent::FAccumulatedKill& Rhs)
{
	return Lhs.KillerPlayerID == Rhs.KillerPlayerID;
}

FORCEINLINE bool operator==(const UMobaKillSystemComponent::FContinuousKill& Lhs, const UMobaKillSystemComponent::FContinuousKill& Rhs)
{
